...
namespace Kinemation.FPSFramework.Runtime.Core.Components
{
    ...
    public class CoreAnimComponent : MonoBehaviour
    {
        ...
        private Tuple<float, float> _rightHandWeight = new Tuple<float, float>(1f, 1f);
        private Tuple<float, float> _leftHandWeight = new Tuple<float, float>(1f, 1f);
        private Tuple<float, float> _rightFootWeight = new Tuple<float, float>(1f, 1f);
        private Tuple<float, float> _leftFootWeight = new Tuple<float, float>(1f, 1f);
